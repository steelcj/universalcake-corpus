...
That is worth stating plainly, because it explains why a checklist is not the point. Most technology evaluation asks: does it work? Does it work fast? Does it work cheaply? These are reasonable questions. But they share an assumption — that the goal of technology is performance, measured against the needs of whoever is already being served. Universal Cake proposes a different goal: technology that builds rather than extracts, that widens participation rather than concentrating it, and that supports human flourishing rather than consuming it. That is not a feature request. It is a change to the goal function — to the question the whole system is organised to answer.

This distinction matters because it changes how everything else in the document should be read. The seven dimensions described in section 4 are not a compliance checklist. They are a set of design commitments that follow from a different answer to the question of what technology is for. When the goal changes, the decisions that follow from it change. That is where the leverage is.
...
The most important implication for technology design is this: because wellbeing and resilience are stocks, the most important design decisions are not the ones that produce immediate results. They are the ones that consistently build the right stocks over time. Accessibility is not valuable because it solves a problem today. It is valuable because it builds the stock of participation, which compounds across years and decades. Open formats do not matter because they are convenient now. They matter because they build the stock of preserved knowledge, which will be available to future maintainers whether or not the original creators are still around.

This reframes every dimension of Universal Cake. It is not a compliance requirement. It is a long-term investment logic — a framework for making design decisions that build the right stocks rather than extracting from them. A technology ecosystem that draws down its stocks of participation, diversity, and preserved knowledge is not efficient. It is consuming its own future.
...
**The bridging capital loop.** The Kevin Kintner story in section 2.3 illustrates this directly. Organisations that reach beyond their known supporters — that invest in the edges rather than harvesting the centre — build bridging capital, which expands the pool of participants, which increases the diversity of perspectives available, which enables better exploration, which builds more bridging capital <a name="apa-march-citation-2"></a>([March, 1991](#apa-march-reference)). The environmental canvassing story is this loop in action. Name it and it becomes a tool any organisation can choose to run.
...
Universal Cake begins with human technology and human wellbeing. But it does not end there — and that choice is not philosophical decoration. It is a practical necessity. Every systems model has a boundary — a decision about what is inside the analysis and what is outside. Where you draw that boundary determines what feedback loops you can see. The most important feedback loops in this system cross every boundary we might try to draw. The health of the oceans, the health of human communities, and the health of the technology ecosystems those communities depend on are not analogous. They are continuous. The same stressors — cumulative load, immune suppression, exclusion from what is needed to function — operate through the same mechanisms whether the subject is a fish population, a minority community, or an organisation whose knowledge has been locked into a proprietary format. A model that draws the boundary between human and ecological systems will always produce dangerously optimistic forecasts, because the costs of extraction do not disappear when you exclude them from the model. They accumulate outside the boundary and eventually re-enter as catastrophic surprises.

First among the context Universal Cake asks us to hold is language — human languages and dialects in all of their varieties, because without language nothing else can be communicated, preserved, or passed on. Beyond human language sits the vast and largely unrecognised communication of the myriad creatures with whom we share this planet — systems of meaning that predate human technology by hundreds of millions of years. The short list was written for one kind of person, in one kind of place, under one set of conditions. Universal Cake asks what happens when you take seriously the full scale of life on earth — and what our responsibility is to design with that scale in mind, rather than in spite of it.
