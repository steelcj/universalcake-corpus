...
The organisations that only work the known turf eventually run out of it. The ones that invest in the edges, in people not yet engaged, are the ones that grow and thrive.
...
What the research establishes, taken together, is this: edge communities bear enormous costs that are not of their making, in health, in economic participation, in life expectancy, and in the chronic burden of navigating systems not designed for them. They also develop, out of necessity, capabilities that those systems badly need: adaptability, creativity, the ability to see clearly from outside, and a hard-won understanding of what actually matters when things go wrong. We are currently extracting those capabilities while simultaneously making the people who carry them sick through exclusion. That is not just unjust. It is a catastrophic waste, of human potential, of economic productivity, and of the very resilience that healthy systems depend on.
