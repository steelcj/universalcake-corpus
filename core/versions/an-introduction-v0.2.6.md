...
### 2.3 The edge, cost, capacity, and the price of ignorance
...
Some other groups talked about dividing the pie fairly, how to share a fixed pool of donors between organisations working in the same movement. Other organizations talked about limiting campaigns, for example, how about we talk about our wildlife work and belugas, and your group talks about other things. Kintner's answer was different and he was frequently correct. The goal, he argued, was not to divide up a static pie. It was to make a  bigger pie.

When a canvasser encountered someone who already gave to another environmental organisation, the right response was to thank them, genuinely, for supporting the movement, and then to talk honestly about what this organisation did, how it worked, and what made it distinct. No competition. No zero-sum thinking. Just more information, more choice, and more trust.

The result was that contributors could more easily discover which organisations most closely matched their own values and commitments. Some gave to multiple groups. Some switched. Others increased their giving overall. The movement grew, and it grew rapidly,  because the approach expanded the number of people who saw themselves as contributors rather than simply seeking out new contributions for existing donors, which, logically, leads to a reduction in contributors over time due to attrition and the failure to invest the resources required in order to create a thriving movement.

This is exactly what <a name="apa-march-citation"></a>[March (1991)](#apa-march-reference) describes as the difference between exploitation and exploration, and what <a name="apa-putnam-citation"></a>[Putnam (2000)](#apa-putnam-reference) identifies as the distinction between bonding capital, strengthening existing relationships, and bridging capital, building new ones across social boundaries.

The organisations that only work the known turf eventually run out of it. The ones that invest in the edges, in people not yet engaged, are the ones that grow and thrive through educations, familiarity and ultimately trust.
...
Human edge communities develop these capacities out of necessity. They learn to adapt, to read systems from the outside, to find solutions in the gaps between what was designed for them and what they actually need.
...
What the research establishes, taken together, is this: edge communities bear enormous costs that are not of their own making, in health, in economic participation, in life expectancy, and in the chronic burden of navigating systems not designed for them.

They also develop, out of necessity, capabilities that those very systems badly need: adaptability, creativity, the ability to see clearly from outside, and a hard-won understanding of what actually matters when things go wrong.

We are currently extracting those capabilities while simultaneously making the people who carry them sick through exclusion. That is not just unjust. It is a catastrophic waste, of human potential, of economic productivity, and of the very resilience that reliable and  functionally healthy systems depend on.

Universal Cake does not ask organisations and technologists to serve edge communities out of charity. It asks them to understand that the edge is where the resilience of the whole system lives, and that a system which excludes its edges is quietly destroying its own capacity to survive.

### 2.4 Therefore...

Universal Cake asks designers, developers, and decision-makers to hold this full picture in mind, not just the target market for a particular product or service, but the full picture, including the cumulative effect of all the target markets together on the people who fall outside most of them.
...
It is also for builders. Developers, designers, and architects who want to think more carefully about what they are creating and why, who it serves, and who it leaves behind.
...
|---------|--------|-------|
| 0.2.4 | Draft | Replaced section 2.3 placeholder with full text: Kevin Kintner canvassing story, March exploitation/exploration, Putnam bonding/bridging capital, Odum ecotone and edge effect, Veblen hyphenate status, Meyer minority stress model, Buckup economic costs of exclusion, Tedeschi and Calhoun post-traumatic growth, Leung and Chiu multicultural creativity; added Brown et al. on inflammation and marginalization; added all new references |
| 0.2.3 | Draft | Author edits for clarity; added Catherine Roy and Vie Autonome Montréal; restructured section 2 with subsections 2.1–2.4; added Treviranus citation for Pareto naming point; placeholder retained for section 2.3 Kevin Kintner story; spelling and grammar corrections throughout |
| 0.2.2 | Draft | Merged author edits to v0.2.0 with new sections 2.1 and 2.2 from v0.2.1; updated Inspirations with expanded list of named inspirations and Meadows provenance detail; corrected section 1 voice and Plone narrative; added Eberhard, Pareto, Statista, and Zheng & Walsham references |
